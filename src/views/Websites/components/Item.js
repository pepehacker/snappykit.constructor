...
// Entities
import { deleteWebsite, getWebsiteLogo } from 'entities/websites';
  ...
  return (
    <div className={rootClassNames}>
      ...
      <div className={styles.Logo}>
        <img alt={title} className={styles.Icon} src={logo} />
      </div>
      ...
      <div className={styles.Actions}>
        {isSupported ? (
          <div className={styles.Links}>
            <Link className={styles.Link} to={`/${id}/editor/templates`}>
          ...
          <div className={styles.NotSupported}>Not Supported</div>
        )}
      </div>
    </div>
  );
...
export default compose(
  ...
  withHandlers({
    handleDelete: ({ appId, deleteWebsite, id, openModal }): func => (
      event: Object
    ): void =>
